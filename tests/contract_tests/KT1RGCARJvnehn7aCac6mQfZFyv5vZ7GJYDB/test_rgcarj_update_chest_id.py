...
class MainnetOperationTestCaseRGCARJ(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'update_chest_id.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'update_chest_id'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_rgcarj(self):
    ...
    def test_lazy_storage_rgcarj(self):
