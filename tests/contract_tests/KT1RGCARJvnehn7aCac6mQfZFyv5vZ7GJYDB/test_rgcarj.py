...
class MainnetContractTestCaseRGCARJ(TestCase):
    ...
    def test_parameter_type_rgcarj(self):
    ...
    def test_entrypoints_rgcarj(self):
    ...
    def test_storage_type_rgcarj(self):
    ...
    def test_storage_encoding_rgcarj(self):
