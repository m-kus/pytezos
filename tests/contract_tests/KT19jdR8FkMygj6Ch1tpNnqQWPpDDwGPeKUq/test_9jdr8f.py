...
class MainnetContractTestCase9JDR8F(TestCase):
    ...
    def test_parameter_type_9jdr8f(self):
    ...
    def test_entrypoints_9jdr8f(self):
    ...
    def test_storage_type_9jdr8f(self):
    ...
    def test_storage_encoding_9jdr8f(self):
