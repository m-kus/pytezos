...
class MainnetOperationTestCase9JDR8F(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'buyTicket.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'buyTicket'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_9jdr8f(self):
    ...
    def test_lazy_storage_9jdr8f(self):
