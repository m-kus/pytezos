...
class MainnetContractTestCaseETKEBI(TestCase):
    ...
    def test_parameter_type_etkebi(self):
    ...
    def test_entrypoints_etkebi(self):
    ...
    def test_storage_type_etkebi(self):
    ...
    def test_storage_encoding_etkebi(self):
