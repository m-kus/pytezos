...
class MainnetContractTestCasePWOZXY(TestCase):
    ...
    def test_parameter_type_pwozxy(self):
    ...
    def test_entrypoints_pwozxy(self):
    ...
    def test_storage_type_pwozxy(self):
    ...
    def test_storage_encoding_pwozxy(self):
