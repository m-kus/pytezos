...
class MainnetContractTestCaseMMKH1V(TestCase):
    ...
    def test_parameter_type_mmkh1v(self):
    ...
    def test_entrypoints_mmkh1v(self):
    ...
    def test_storage_type_mmkh1v(self):
    ...
    def test_storage_encoding_mmkh1v(self):
