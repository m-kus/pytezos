...
class MainnetOperationTestCaseMMKH1V(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'claim.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'claim'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_mmkh1v(self):
    ...
    def test_lazy_storage_mmkh1v(self):
