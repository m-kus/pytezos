...
class MainnetContractTestCaseRA1JJ9(TestCase):
    ...
    def test_parameter_type_ra1jj9(self):
    ...
    def test_entrypoints_ra1jj9(self):
    ...
    def test_storage_type_ra1jj9(self):
    ...
    def test_storage_encoding_ra1jj9(self):
