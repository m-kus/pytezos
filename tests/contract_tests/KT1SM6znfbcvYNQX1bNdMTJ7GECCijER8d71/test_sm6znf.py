...
class MainnetContractTestCaseSM6ZNF(TestCase):
    ...
    def test_parameter_type_sm6znf(self):
    ...
    def test_entrypoints_sm6znf(self):
    ...
    def test_storage_type_sm6znf(self):
    ...
    def test_storage_encoding_sm6znf(self):
