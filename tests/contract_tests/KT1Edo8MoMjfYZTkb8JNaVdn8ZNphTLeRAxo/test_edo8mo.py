...
class MainnetContractTestCaseEDO8MO(TestCase):
    ...
    def test_parameter_type_edo8mo(self):
    ...
    def test_entrypoints_edo8mo(self):
    ...
    def test_storage_type_edo8mo(self):
    ...
    def test_storage_encoding_edo8mo(self):
