...
class MainnetContractTestCaseTYXEQR(TestCase):
    ...
    def test_parameter_type_tyxeqr(self):
    ...
    def test_entrypoints_tyxeqr(self):
    ...
    def test_storage_type_tyxeqr(self):
    ...
    def test_storage_encoding_tyxeqr(self):
