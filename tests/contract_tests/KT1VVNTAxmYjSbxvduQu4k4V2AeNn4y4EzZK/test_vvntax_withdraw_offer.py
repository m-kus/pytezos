...
class MainnetOperationTestCaseVVNTAX(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'withdraw_offer.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'withdraw_offer'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_vvntax(self):
    ...
    def test_lazy_storage_vvntax(self):
