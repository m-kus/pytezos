...
class MainnetContractTestCaseVVNTAX(TestCase):
    ...
    def test_parameter_type_vvntax(self):
    ...
    def test_entrypoints_vvntax(self):
    ...
    def test_storage_type_vvntax(self):
    ...
    def test_storage_encoding_vvntax(self):
