...
class MainnetContractTestCaseJYC6SH(TestCase):
    ...
    def test_parameter_type_jyc6sh(self):
    ...
    def test_entrypoints_jyc6sh(self):
    ...
    def test_storage_type_jyc6sh(self):
    ...
    def test_storage_encoding_jyc6sh(self):
