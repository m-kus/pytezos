...
class MainnetContractTestCaseSTKBRU(TestCase):
    ...
    def test_parameter_type_stkbru(self):
    ...
    def test_entrypoints_stkbru(self):
    ...
    def test_storage_type_stkbru(self):
    ...
    def test_storage_encoding_stkbru(self):
