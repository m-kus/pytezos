...
class MainnetContractTestCaseHLCHQN(TestCase):
    ...
    def test_parameter_type_hlchqn(self):
    ...
    def test_entrypoints_hlchqn(self):
    ...
    def test_storage_type_hlchqn(self):
    ...
    def test_storage_encoding_hlchqn(self):
