...
class MainnetOperationTestCaseHLCHQN(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'execute.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'execute'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_hlchqn(self):
    ...
    def test_lazy_storage_hlchqn(self):
