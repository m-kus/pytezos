...
class MainnetContractTestCaseVEDF8R(TestCase):
    ...
    def test_parameter_type_vedf8r(self):
    ...
    def test_entrypoints_vedf8r(self):
    ...
    def test_storage_type_vedf8r(self):
    ...
    def test_storage_encoding_vedf8r(self):
