...
class MainnetContractTestCase93SICB(TestCase):
    ...
    def test_parameter_type_93sicb(self):
    ...
    def test_entrypoints_93sicb(self):
    ...
    def test_storage_type_93sicb(self):
    ...
    def test_storage_encoding_93sicb(self):
