...
class MainnetContractTestCase8D8C1W(TestCase):
    ...
    def test_parameter_type_8d8c1w(self):
    ...
    def test_entrypoints_8d8c1w(self):
    ...
    def test_storage_type_8d8c1w(self):
    ...
    def test_storage_encoding_8d8c1w(self):
