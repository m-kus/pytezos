...
class MainnetOperationTestCaseHQXXHC(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'cancel_trade.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'cancel_trade'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_hqxxhc(self):
    ...
    def test_lazy_storage_hqxxhc(self):
