...
class MainnetContractTestCaseHQXXHC(TestCase):
    ...
    def test_parameter_type_hqxxhc(self):
    ...
    def test_entrypoints_hqxxhc(self):
    ...
    def test_storage_type_hqxxhc(self):
    ...
    def test_storage_encoding_hqxxhc(self):
