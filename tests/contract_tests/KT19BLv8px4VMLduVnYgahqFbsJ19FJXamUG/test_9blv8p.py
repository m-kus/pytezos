...
class MainnetContractTestCase9BLV8P(TestCase):
    ...
    def test_parameter_type_9blv8p(self):
    ...
    def test_entrypoints_9blv8p(self):
    ...
    def test_storage_type_9blv8p(self):
    ...
    def test_storage_encoding_9blv8p(self):
