...
class MainnetOperationTestCase9BLV8P(TestCase):
    ...
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'update_operators.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'update_operators'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_9blv8p(self):
    ...
    def test_lazy_storage_9blv8p(self):
