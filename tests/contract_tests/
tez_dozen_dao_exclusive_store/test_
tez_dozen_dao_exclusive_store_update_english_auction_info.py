...
class MainnetOperationTestCase
TEZ_DOZEN_DAO_EXCLUSIVE_STORE(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'update_english_auction_info.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'update_english_auction_info'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_
tez_dozen_dao_exclusive_store(self):
