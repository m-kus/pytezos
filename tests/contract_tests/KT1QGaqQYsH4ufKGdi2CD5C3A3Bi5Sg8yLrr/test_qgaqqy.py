...
class MainnetContractTestCaseQGAQQY(TestCase):
    ...
    def test_parameter_type_qgaqqy(self):
    ...
    def test_entrypoints_qgaqqy(self):
    ...
    def test_storage_type_qgaqqy(self):
    ...
    def test_storage_encoding_qgaqqy(self):
