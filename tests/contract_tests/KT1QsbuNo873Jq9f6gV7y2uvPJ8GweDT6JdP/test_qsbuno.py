...
class MainnetContractTestCaseQSBUNO(TestCase):
    ...
    def test_parameter_type_qsbuno(self):
    ...
    def test_entrypoints_qsbuno(self):
    ...
    def test_storage_type_qsbuno(self):
    ...
    def test_storage_encoding_qsbuno(self):
