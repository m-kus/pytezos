...
class MainnetContractTestCaseRRQGAE(TestCase):
    ...
    def test_parameter_type_rrqgae(self):
    ...
    def test_entrypoints_rrqgae(self):
    ...
    def test_storage_type_rrqgae(self):
    ...
    def test_storage_encoding_rrqgae(self):
