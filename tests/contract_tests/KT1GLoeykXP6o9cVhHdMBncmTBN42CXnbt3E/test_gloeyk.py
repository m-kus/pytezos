...
class MainnetContractTestCaseGLOEYK(TestCase):
    ...
    def test_parameter_type_gloeyk(self):
    ...
    def test_entrypoints_gloeyk(self):
    ...
    def test_storage_type_gloeyk(self):
    ...
    def test_storage_encoding_gloeyk(self):
