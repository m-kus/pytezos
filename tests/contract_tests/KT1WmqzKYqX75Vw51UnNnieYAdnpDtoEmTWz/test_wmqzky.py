...
class MainnetContractTestCaseWMQZKY(TestCase):
    ...
    def test_parameter_type_wmqzky(self):
    ...
    def test_entrypoints_wmqzky(self):
    ...
    def test_storage_type_wmqzky(self):
    ...
    def test_storage_encoding_wmqzky(self):
