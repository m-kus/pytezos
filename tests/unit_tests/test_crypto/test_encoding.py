...
from pytezos.crypto.encoding import base58_decode, base58_encode, is_bh, is_pkh, is_sig, scrub_input
...
class TestEncoding(TestCase):
    @parameterized.expand(
        [
            ...
            (b'edsigtzLBGCyadERX1QsYHKpwnxSxEYQeGLnJGsSkHEsyY8vB5GcNdnvzUZDdFevJK7YZQ2ujwVjvQZn62ahCEcy74AwtbA8HuN', b'edsig'),
            (b'spsig1RriZtYADyRhyNoQMa6AiPuJJ7AUDcrxWZfgqexzgANqMv4nXs6qsXDoXcoChBgmCcn2t7Y3EkJaVRuAmNh2cDDxWTdmsz', b'spsig'),
            (b'sigUdRdXYCXW14xqT8mFTMkX4wSmDMBmcW1Vuz1vanGWqYTmuBodueUHGPUsbxgn73AroNwpEBHwPdhXUswzmvCzquiqtcHC', b'sig'),
        ]
    )
