...
from pytezos.michelson.types.base import MichelsonType, parse_micheline_literal, undefined, LazyStorage
    ...
    def aggregate_lazy_diff(self, lazy_diff: List[dict], mode='readable'):
        ...
        def make_update(key: MichelsonType, val: Optional[MichelsonType]) -> dict:
            update = {
                ...
                'key_hash': get_key_hash(key.pack())
            }
            if val is not None:
