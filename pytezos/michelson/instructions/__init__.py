...
from pytezos.michelson.instructions.jupyter import (DebugInstruction, DropAllInstruction, DumpAllInstruction, DumpInstruction,
                                                    PatchInstruction, PatchValueInstruction, PrintInstruction, ResetInstruction,
                                                    ResetValueInstruction)
