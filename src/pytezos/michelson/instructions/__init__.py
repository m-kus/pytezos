...
from pytezos.michelson.instructions.crypto import (
    Blake2bInstruction,
    CheckSignatureInstruction,
    HashKeyInstruction,
    KeccakInstruction,
    PairingCheckInstruction,
    SaplingEmptyStateInstruction,
    SaplingVerifyUpdateInstruction,
    Sha3Instruction,
    Sha256Instruction,
    Sha512Instruction,
)
